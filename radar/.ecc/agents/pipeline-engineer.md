...
**Complexity v2.2:** BORDERLINE usa catena COMPLEX (`purpose=classify:complex`) con effort da `LLM_BORDERLINE_REASONING_EFFORT` (default/ops tipico `high` + escalate `high`); SIMPLE → `classify:simple`.
