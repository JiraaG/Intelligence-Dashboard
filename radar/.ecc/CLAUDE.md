...
> - **Archi:** MapLibre great-circle macro multicolore solida (tutti gli zoom); Leaflet `relationsPane` z 550 = zoom &lt; 5 multicolore / ≥ 5 tratteggio + fan; click → `loadRelationArticles`.
