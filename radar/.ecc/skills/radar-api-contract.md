...
| Metrics Summary | `GET /api/metrics/summary?from=&to=` | JSON `{from, to, total_articles, total_clean_chars, total_clean_words, avg_pipeline_latency_ms, avg_embedding_time_ms, llm: {total_requests, total_prompt_tokens, total_completion_tokens, total_cached_prompt_tokens, cache_hit_rate_pct, avg_execution_time_ms}, dedup: {total_events, url_exact_count, semantic_vector_count, content_hash_count}}` |
