...
import { RadarMapLeafletComponent } from './radar-map-leaflet.component';
import {
  installLeafletStub,
...
@Component({
  ...
  standalone: true,
  imports: [RadarMapLeafletComponent],
  template: `
    <app-radar-map-leaflet
      [articles]="articles"
      [countries]="countries"
...
describe('RadarMapLeafletComponent (Phase 4)', () => {
  ...
  function getMapCmp(fixture: {
    ...
    return fixture.debugElement.children[0].componentInstance as RadarMapLeafletComponent;
  }
