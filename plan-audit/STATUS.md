...
Quadro operativo aggiornato **2026-07-24** (FinOps UI Metrics **COMPLETE / GATE VERDE**; Eager drain worker **COMPLETE / GATE VERDE**; FinOps LLM Wave A **COMPLETE / GATE VERDE (condizionato)**; Fase C semantic dedup **GATE VERDE**; Metrics 013 **COMPLETE / GATE VERDE**; MapLibre hatching isole/anti-bleed **GATE VERDE**; Wave 1 Relazioni nazioni **GATE VERDE**; Fase A LLM locale **COMPLETE**).  
...
| Area | Dove | Note |
|------|------|------|
| FinOps UI — card + STATUS topbar (Fase 013 UI + Audit) | [`complete/plan_impl_finops_ui_metrics.md`](complete/plan_impl_finops_ui_metrics.md) | **COMPLETE / GATE VERDE** 2026-07-24 — W0–W7 + closeout F1–F6 + Audit DeepSeek $0.11 riconciliato. Card sidebar FinOps, topbar STATUS & COSTI popover, rxResource reattivo al cambio data (prefer summary total_estimated_cost_usd su metricsStatus). Walkthrough: [`complete/walkthrough_finops_ui_metrics.md`](complete/walkthrough_finops_ui_metrics.md), Audit: [`complete/audit_finops_status_costs_numbers.md`](complete/audit_finops_status_costs_numbers.md). Prompts: [`prompts/done/agent_prompt_finops_ui_metrics.md`](prompts/done/agent_prompt_finops_ui_metrics.md), [`prompts/done/agent_prompt_finops_ui_closeout.md`](prompts/done/agent_prompt_finops_ui_closeout.md), [`prompts/done/agent_prompt_audit_finops_status_costs.md`](prompts/done/agent_prompt_audit_finops_status_costs.md). |
