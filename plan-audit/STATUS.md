...
Quadro operativo aggiornato **2026-07-24** (Eager drain worker **COMPLETE / GATE VERDE**; FinOps LLM Wave A **COMPLETE / GATE VERDE (condizionato)**; Fase C semantic dedup **GATE VERDE**; Metrics 013 **COMPLETE / GATE VERDE**; MapLibre hatching isole/anti-bleed **GATE VERDE**; Wave 1 Relazioni nazioni **GATE VERDE**; Fase A LLM locale **COMPLETE**).  
