...
SoT: `plan-audit/active/plan_docs_audit_ticket_status.md`
...
| **C** | `generalPurpose` | **Docs + Script I + gate** | `plan-audit/remediation/audit_remediation_T-P0-02.md`, `plan-audit/active/plan_docs_audit_ticket_status.md` (§3 ticket + pie OPEN counts + § esito se esiste pattern §10–13), pezzi rilevanti di `plan-audit/active/plan_docs_audit_playbook.md` (§3.2/§4.5 criteri spuntati / App. D se presente). Esegue gate comandi. | logica prodotto fuori script/test; commit |
...
- plan-audit/active/plan_docs_audit_ticket_status.md §3: T-P0-02 DONE; pie P0 OPEN=0;
  OPEN totali coerenti; §5 ordine; nuova § esito tipo §14 se il doc segue quel pattern
- plan-audit/active/plan_docs_audit_playbook.md: §3.2/§4.5 come AS-IS storico + criteri spuntati;
